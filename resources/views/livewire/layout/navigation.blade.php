...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 md:flex">
                    ...
                    <x-nav-link :href="route('establishments.index')" :active="request()->routeIs('establishments.index')" wire:navigate>
                        Establecimientos
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('persons.index')" :active="request()->routeIs('persons.index')" wire:navigate>
                Clientes
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('establishments.index')" :active="request()->routeIs('establishments.index')" wire:navigate>
                Establecimientos
            </x-responsive-nav-link>
