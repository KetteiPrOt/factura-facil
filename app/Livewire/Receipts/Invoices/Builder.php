...
class Builder
{
    ...
    public function build(array $validated, User $user): string
    {
        ...
        $invoice = str_replace('{{pay_methods}}', $this->pay_method, $invoice);
    ...
    private function setAttributes(array $validated, User $user): void
    {
        ...
        $this->pay_method = $this->payMethod($validated['pay_method_id']);
    ...
    private function payMethod(string $pay_method_id): string
    {
        $payMethod = PayMethod::find($pay_method_id);
        $pay_method =
                          "<pago>\n"
    ...
    ): string
    {
        $access_key = 
            ...
            . $sequential
            . fake()->numberBetween(10000000, 99999999) // random number code (8 length)
